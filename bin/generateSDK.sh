...
yarn graphdoc -e https://api.pipefy.com/graphql -x "Authorization: Bearer $GRAPHQL_TOKEN" -p graphdoc-schema-json-plugin -o ./doc/schema
php ./bin/generatePhpApi.php
